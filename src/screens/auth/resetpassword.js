    ...
    <>
      {
        sent ? (
            <View className=' md:w-[450px] rounded-xl mx-auto justify-center flex items-center flex-col sm:mt-36 lg:mt-auto h-[100vh]  md:h-[100vh]'>
                ...
                <Text style={{ fontSize:24,fontFamily:'Poppins_600SemiBold', color:'#000', marginBottom:5}}>Password reset was successful.</Text>
                <Button
                ...
                <>
                    ...
                    borderBottomRightRadius: 100 / 2
                        ...
                        <View style={{ backgroundColor: '#fff',   flexDirection: 'column', paddingHorizontal:25, paddingVertical:'6%',  borderTopRightRadius:100/2, borderBottomLeftRadius:100/2, borderBottomRightRadius:100/2 }}>
                            <Text style={{ fontSize:24,fontFamily:'Poppins_600SemiBold', color:'#000', marginBottom:5}}>Reset Password</Text>
                            <Text style={{ fontSize:16,fontFamily:'Poppins_600SemiBold', color:'#555', marginBottom:10}}>Create new password for your Muxt account</Text>
                            <TextInput
                                mode='flat'
                                value={password}
                                label="Password"
