...
import TabePageLayout from '../../layout/tabPageLayout';
...
export const Feed = () => {
  ...
  // Get shared
   const getShared = async () => {
    try {
      const q = query(collection(db, "shares"), where("sharerId", "==", storedCredentials), orderBy("timeStamp", "desc"));
  ...
  return (
    ...
    >
      ...
      <PostPreviewModal isModalVisible={isModalVisible}
