    ...
    <>
      ...
      >
          ...
          >
            ...
            <View style={{ marginTop: 3 }}>
              <TouchableOpacity onPress={viewProfile}>
                ...
                >
                  Sponsored <TimeAgo time={time * 1000} interval={20000} />
                </Text>
              </TouchableOpacity>
            </View>
          </View>
        ...
        >
          ...
          {data.connectOption && (
            <TouchableHighlight
              ...
              onPress={
                data?.connectOption === "BUTTON"
                  ? handleChat
                  : () => openWebUrl(data.campaignWebsite)
              }
              style={{
                zIndex: 1,
                width: "100%",
        ...
        <View style={{ paddingHorizontal: 10, position: "relative" }}>
          <View
            style={{ flexDirection: "row", paddingTop: 14, paddingBottom: 7 }}
          >
            <View style={{ flex: 1 }}>
              <View
                style={{
              ...
              >
                <TouchableOpacity onPress={handleLike}>
                  <AntDesign
                    ...
                    size={24}
                    color={liked === true ? Colors.bluePrimary : "black"}
                  />
                </TouchableOpacity>
              </View>
            </View>
          ...
          >
            {data.campaignTitle && data.campaignTitle.substring(0, 46)}
            {data.campaignTitle && data.campaignTitle.length > 46 ? "..." : ""}
          </Text>
          <TouchableHighlight
            underlayColor="none"
          ...
          >
            <>
              ...
              >
                {data.campaignDescription && !showMore
                  ? data.campaignDescription.substring(0, 90)
                  : data.campaignDescription.substring(0)}
                {!showMore &&
                data.campaignDescription &&
                data.campaignDescription.length > 90
                  ? "... See more"
                  : ""}
              </Text>
              {showMore && (
